...
(
    ...
    cd build/googletest
    cmake CMakeLists.txt -DCMAKE_TOOLCHAIN_FILE=/Users/gswirski/Code/wc/ethSTARK/ios.toolchain.cmake -DPLATFORM=OS64 -DCMAKE_INSTALL_PREFIX=../../vendor
    make -j
    make install
)
...
(
    ...
    cd build/benchmark
    cmake CMakeLists.txt -DCMAKE_TOOLCHAIN_FILE=/Users/gswirski/Code/wc/ethSTARK/ios.toolchain.cmake -DPLATFORM=OS64 -DCMAKE_INSTALL_PREFIX=../../vendor # -DCMAKE_BUILD_TYPE=Release 
    make -j
    make install
)
